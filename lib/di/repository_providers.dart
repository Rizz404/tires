...
import 'package:tires/features/menu/data/repositories/menu_repository_impl.dart';
...
import 'package:tires/features/user/data/repositories/users_repository_impl.dart';
...
final usersRepoProvider = Provider<UsersRepository>((ref) {
  final _usersRemoteDatasource = ref.watch(usersRemoteDatasourceProvider);
  return UsersRepositoryImpl(_usersRemoteDatasource);
});
...
final contactRepoProvider = Provider<ContactRepository>((ref) {
  final _contactRemoteDatasource = ref.watch(contactRemoteDatasourceProvider);
  return ContactRepositoryImpl(_contactRemoteDatasource);
});
